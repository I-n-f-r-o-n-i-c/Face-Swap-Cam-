...
image = cv2.imread("c7acf191ec5011a895eb22d9dbc83b85.jpg") # enter the image path here
if image is None:
...
while True:
    ...
    dest_image = cv2.flip(dest_image, 1)  # Mirror the image horizontally
